Rails.application.routes.draw do
  ...
  resources :news_categories, :post_categories, only: [:update, :destroy]
  ...
  resources :news, :posts, :entries, only: [:update, :destroy]
  ...
  scope '(:locale)', constraints: { locale: /ru|en/ } do
    ...
    resources :news_categories, :post_categories, except: [:index, :show, :update, :destroy]
